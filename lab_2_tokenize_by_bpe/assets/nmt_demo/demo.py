...
def translate(model: MarianMTModel, tokenizer: MarianTokenizer, input_text: str) -> str:
    """
    ...
    Args:
        model (MarianMTModel): The model used for translation
        tokenizer (MarianTokenizer): The tokenizer used for text encoding and decoding
        input_text (str): The text to be translated

    Returns:
        str: Text translation
    """
...
def load_model(model_name: str) -> tuple[MarianMTModel, MarianTokenizer]:
    ...
    Returns:
        tuple[MarianMTModel, MarianTokenizer]: A tuple with the model and tokenizer
    """
