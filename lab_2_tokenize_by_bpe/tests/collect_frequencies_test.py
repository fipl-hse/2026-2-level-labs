...
@pytest.mark.mark8
@pytest.mark.mark10
def test_collect_frequencies_ideal() -> None:
    """
    ...
    actual = collect_frequencies(
        "На отдельных частях острова птенцов особенно много. "
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_collect_frequencies_none_prepared_word() -> None:
    """
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_collect_frequencies_bad_input() -> None:
    """
    ...
    for start_bad_input in start_of_word_bad_input:
        actual = collect_frequencies(
            "На отдельных частях острова птенцов особенно много.", start_bad_input, "</s>"
        )
        assert expected == actual
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_collect_frequencies_return_value() -> None:
    """
