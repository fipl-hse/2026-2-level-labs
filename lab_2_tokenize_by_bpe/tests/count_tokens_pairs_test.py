...
def word_frequencies() -> dict:
    """
    Prepare reference configuration data.
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_count_tokens_pairs_ideal(word_frequencies: dict) -> None:
    """
    Ideal count tokens pairs scenario.

    Args:
        word_frequencies (dict): Correct frequency data dictionary.
    """
    expected = {
        ("В", "е"): 1,
        ("е", "з"): 1,
    ...
    actual = count_tokens_pairs(word_frequencies)
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_count_tokens_pairs_bad_input() -> None:
    """
...
@pytest.mark.mark8
@pytest.mark.mark10
def test_count_tokens_pairs_return_value(word_frequencies: dict) -> None:
    """
