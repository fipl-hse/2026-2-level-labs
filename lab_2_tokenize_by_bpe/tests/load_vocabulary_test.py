...
@pytest.mark.mark10
def test_load_vocabulary_ideal(setup: tuple) -> None:
    """
    ...
    actual = load_vocabulary(vocabulary_path)
    assert expected == actual


@pytest.mark.lab_2_tokenize_by_bpe
@pytest.mark.mark10
def test_load_vocabulary_internal_type(setup: tuple) -> None:
    """
    ...
    Args:
        setup (tuple): Prepared test data.
    """
    _, path_to_invalid_vocabulary = setup

    expected = None
    actual = load_vocabulary(path_to_invalid_vocabulary)
    assert expected == actual


@pytest.mark.lab_2_tokenize_by_bpe
@pytest.mark.mark10
def test_load_vocabulary_bad_input() -> None:
    """
...
@pytest.mark.lab_2_tokenize_by_bpe
@pytest.mark.mark10
def test_load_vocabulary_return_value(setup: tuple) -> None:
    """
